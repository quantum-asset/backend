...
export const createListOfLocacion = () => {
  return [
    ...
    LOCACION_MOCK(7,1,"PETROMEX-EDS CHORRILLOS","Av. Guardia Civil Sur 203, Chorrillos 15056","GNV-GLP-G90-G95-DB5",1),
    ...
    // LOCACION_MOCK(15,1,"PETROMEX-EDS LUNA PIZARRO","Jirón Hipólito Unanue 457, La Victoria 15033","GNV",1),
...
export const createListOfUsuario =()=>{
  return [
    ...
    USUARIO_MOCK(3,2,3,2,"Helena.Grisky@kamui.com","1234567","Helena","Grisky","","DNI","4303213",new Date(),new Date(),1),
    ...
    USUARIO_MOCK(12,4,12,2,"Emilia.Galván@kamui.com","1234567","Emilia","Galván","","DNI","28203214",new Date(),new Date(),1),
    USUARIO_MOCK(13,1000,13,3,"Aida.Sandoval@kamui.com","1234567","Aida","Sandoval","","DNI","5257503",new Date(),new Date(),1),
    ...
    USUARIO_MOCK(17,3,17,2,"Delia.Vallejos@kamui.com","1234567","Delia","Vallejos","","DNI","19818033",new Date(),new Date(),1),
...
export const createListOfTrazabilidad=()=>{
  return[
    TRAZABILIDAD_MOCK(1,1,new Date(2020,15,03),"registro de usuario",),
    TRAZABILIDAD_MOCK(1,2,new Date(2020,15,03),"modificación de usuario",),
    TRAZABILIDAD_MOCK(2,1,new Date(2020,15,03),"registrode nuevo activo",),
    TRAZABILIDAD_MOCK(3,1,new Date(2020,15,03),"registrode nuevo activo",),
    TRAZABILIDAD_MOCK(7,1,new Date(2020,15,03),"Registro de toma de inventario",),
    TRAZABILIDAD_MOCK(9,1,new Date(2020,15,03),"Registro de toma de inventario",),
    TRAZABILIDAD_MOCK(12,4,new Date(2020,15,03),"Registro de nuevo activo",),
    TRAZABILIDAD_MOCK(13,1,new Date(2020,15,03),"Registro de toma de inventario",),
    TRAZABILIDAD_MOCK(14,1,new Date(2020,15,03),"Registro de toma de inventario",),
    TRAZABILIDAD_MOCK(15,3,new Date(2020,15,03),"Generación de reporte de activoss por locacion",),
...
export const createListOfTag=()=>{
  return[
    ...
    TAG_MOCK(3,"2021000003",1,1,new Date(2020,12,5),new Date(2020,12,25),1,),
    ...
    TAG_MOCK(30,"2021000030",2,3,new Date(2021,7,1),new Date(2021,7,9),1,),
    TAG_MOCK(31,"2021000031",2,3,new Date(2021,7,1),new Date(2021,7,9),1,),
    TAG_MOCK(32,"2021000032",2,3,new Date(2021,7,1),new Date(2021,7,9),1,),
    TAG_MOCK(33,"2021000033",2,3,new Date(2021,7,1),new Date(2021,7,9),1,),
    TAG_MOCK(34,"2021000034",2,3,new Date(2021,7,1),new Date(2021,7,9),1,),
    TAG_MOCK(35,"2021000035",2,3,new Date(2021,7,1),new Date(2021,7,9),1,),
    TAG_MOCK(36,"2021000036",2,3,new Date(2021,7,1),new Date(2021,7,9),1,),
    TAG_MOCK(37,"2021000037",2,3,new Date(2021,7,1),new Date(2021,7,9),1,),
    TAG_MOCK(38,"2021000038",2,3,new Date(2021,7,1),new Date(2021,7,9),1,),
    TAG_MOCK(39,"2021000039",2,3,new Date(2021,7,1),new Date(2021,7,9),1,),
    ...
    TAG_MOCK(103,"2021000103",5,20,new Date(2021,9,20),new Date(2021,10,1),1,),
...
export const createListOfActivo=()=>{
  return[
    ...
    ACTIVO_MOCK(3,3,3,1,1,1,"Smarthphone","Pantalla: 6,7 pulgadas;    Resolución: 2.400 x 1.080 píxeles;    Tasa de actualización máxima: 120 Hz;    Procesador: Exynos 2100;    RAM: 8GB;    Almacenamiento: 256 GB;    MicroSD: no;    Cámaras principales: 12 megapíxeles(f/1.8) + gran angular 12 megapíxeles (f/2.2) + telefoto 64 megapíxeles (f/2.0) con zoom óptico híbrido 3x y zoom digital hasta de 30x;    Cámara frontal: 10 megapíxeles;   Resistencia al agua: sí, con la certificación IP68;    Batería: 4.800m Ah;    Carga inalámbrica: sí;    Carga inalámbrica reversible: sí;    Carga rápida: 25 vatios (25W);    Sistema operativo: Android 11;    5G: sí, mmWave y Sub-6;    Lector de huellas: sí, en la pantalla;","El dispositivo tiene una lijera rayadura en el vborde superior izquierdo de la pantalla; sin conector de audífonos de 3,5 mm, UWB, NFC (sin MST), pantalla planta y no trae cargador ni audífonos en la caja","CTFVYG-VTY-VYB-0003","Phantom black","Galaxy S21 +; SM-G996U3","Samsung","4502","555089","481656562","1022295110","SAMTRONICS S.A","TI",new Date(2020,10,20),new Date(2020,10,20),new Date(2020,10,20),1),
    ...
    ACTIVO_MOCK(9,9,9,5,2,1,"Silla de escritorio","Silla ergonómica, giratoria y ajustable","-","-","Negro","MG-EC-014","Swivel Executive Chair","345.2","555089","481656562","1022295110","Guangzhou Mige Furniture Co. LTD.","TI",new Date(2020,01,12),new Date(2021,01,12),new Date(2021,01,12),1),
    ACTIVO_MOCK(10,10,10,5,2,1,"Silla de escritorio","Silla ergonómica, giratoria y ajustable","-","-","Negro","MG-EC-014","Swivel Executive Chair","345.2","555089","481656562","1022295110","Guangzhou Mige Furniture Co. LTD.","TI",new Date(2020,01,12),new Date(2021,01,12),new Date(2021,01,12),1),
    ACTIVO_MOCK(11,11,11,3,2,3,"Bomba de succión","Tipo: cuádruplo con 4 suministros simultaneos","-","HGVJ-HVUBJ-6918","Negro y gris plateado","PRIME S","Gilbarco Veeder-Root","15000","31835636861","369166516","2040103056","Gilbarco Veeder-Root","Comercial",new Date(2020,10,20),new Date(2021,02,26),new Date(2021,02,26),1),
    ACTIVO_MOCK(12,12,12,3,2,3,"Bomba de succión","Tipo: cuádruplo con 4 suministros simultaneos","-","HGVJ-HVUBJ-6919","Negro y gris plateado","PRIME S","Gilbarco Veeder-Root","15000","31835636861","369166516","2040103056","Gilbarco Veeder-Root","Comercial",new Date(2020,10,20),new Date(2021,02,26),new Date(2021,02,26),1),
    ACTIVO_MOCK(13,13,13,3,2,3,"Bomba de succión","Tipo: cuádruplo con 4 suministros simultaneos","-","HGVJ-HVUBJ-6920","Negro y gris plateado","PRIME S","Gilbarco Veeder-Root","15000","31835636861","369166516","2040103056","Gilbarco Veeder-Root","Comercial",new Date(2020,10,20),new Date(2021,02,26),new Date(2021,02,26),1),
    ACTIVO_MOCK(14,14,14,3,2,3,"Dispensador de combustible","Tipo: cuádruplo con 4 suministros simultaneos","-","HGVJ-HVUBJ-6921","Negro y gris plateado","PRIME S","Gilbarco Veeder-Root","15000","31835636861","369166516","2040103056","Gilbarco Veeder-Root","Comercial",new Date(2020,10,20),new Date(2021,02,26),new Date(2021,02,26),1),
    ACTIVO_MOCK(15,15,15,3,3,3,"Dispensador de combustible","Tipo: cuádruplo con 4 suministros simultaneos","-","HGVJ-HVUBJ-6922","Negro y gris plateado","PRIME S","Gilbarco Veeder-Root","15000","888136861","369166517","2040103056","Gilbarco Veeder-Root","Comercial",new Date(2020,10,20),new Date(2021,04,22),new Date(2021,04,22),1),
    ACTIVO_MOCK(16,16,16,3,3,3,"Dispensador de combustible","Tipo: cuádruplo con 4 suministros simultaneos","-","HGVJ-HVUBJ-6923","Negro y gris plateado","PRIME S","Gilbarco Veeder-Root","15000","888136861","369166517","2040103056","Gilbarco Veeder-Root","Comercial",new Date(2020,10,20),new Date(2021,04,22),new Date(2021,04,22),1),
    ACTIVO_MOCK(17,17,17,4,2,5,"Lector RFID","Lector RFID con slot para integrar smarthphone","-","ZBR-025-0895","Gris","RFD8500 BT","Zebra","870.99","6511613220","8885241","202052235","Zebra Technologies Corporation","Logística",new Date(2020,10,20),new Date(2021,06,20),new Date(2020,10,20),1),
    ACTIVO_MOCK(18,18,18,4,2,5,"Lector RFID","Lector RFID con slot para integrar smarthphone","-","ZBR-025-0896","Gris","RFD8500 BT","Zebra","870.99","6511613220","8885241","202052235","Zebra Technologies Corporation","Logística",new Date(2020,10,20),new Date(2021,06,20),new Date(2020,10,20),1),
    ACTIVO_MOCK(19,19,19,4,2,5,"Lector RFID","Lector RFID con slot para integrar smarthphone","-","ZBR-025-0897","Gris","RFD8500 BT","Zebra","870.99","6511613220","8885241","202052235","Zebra Technologies Corporation","Logística",new Date(2020,10,20),new Date(2021,06,20),new Date(2020,10,20),1),
...
export const createListOfTomaInventario=()=>{
  return [
    TOMA_INVENTARIO_MOCK(1,"Todo completo",1,1,new Date(10,02,2019),null,0,),
    TOMA_INVENTARIO_MOCK(2,"Faltó un repuesto de pistola de suministro de combustible",1,2,new Date(10,02,2019),null,1,),
    TOMA_INVENTARIO_MOCK(3,"Existen incongruencias, el detalle esta especificaco por cada locación. Además, en la Estacion central se negó el acceso durante media hora.",0,4,new Date(01,08,2020),new Date(05,08,2020),1,),
...
export const createListOfTomaInventarioXLocacion=()=>{
  return [
    TOMA_INVENTARIO_X_LOCACION_MOCK(1,1,new Date(2019,02,08),"Todo completo",),
    TOMA_INVENTARIO_X_LOCACION_MOCK(2,2,new Date(2019,02,10),"Todo completo",),
    TOMA_INVENTARIO_X_LOCACION_MOCK(2,3,new Date(2019,02,11),"Faltó un repuesto de pistola de suministro de combustible",),
    TOMA_INVENTARIO_X_LOCACION_MOCK(3,2,new Date(2020,08,01),"Todo completo",),
    TOMA_INVENTARIO_X_LOCACION_MOCK(3,3,new Date(2020,08,02),"Algunos activos se encuentran en no muy buenas condiciones.",),
    TOMA_INVENTARIO_X_LOCACION_MOCK(3,4,new Date(2020,08,05),"Todo completo",),
    TOMA_INVENTARIO_X_LOCACION_MOCK(3,5,new Date(2020,08,05),"Todo completo",),
